...
class TechnicalFactor(Factor, metaclass=FactorMeta):
    def __init__(self,
        ...
        self.data_schema = get_kdata_schema(entityType, level=level, adjust_type=adjust_type)
        ...
        super().__init__(region, self.data_schema, entity_schema, provider, entity_ids, exchanges, codes,
