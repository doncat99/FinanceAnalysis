...
def cal_ma_states(region, start='000001', end='002000'):
    logger.info(f'start cal day ma stats {start}:{end}')

    entities = get_entities(region,
    ...
    ma_1wk_stats = MaStateStatsFactor(region,
                                      codes=codes, 
                                      start_timestamp='2005-01-01',
                                      end_timestamp=now_pd_timestamp(Region.CHN),
